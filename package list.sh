...
sudo pacman -S sway swaybg swayidle swaylock wlroots waybar kitty thunar-volman tuned tuned-ppd thunar xorg-xwayland thunar-archive-plugin ark copyq swaync grim xorg-xhost tumbler brightnessctl polkit-gnome xdg-desktop-portal-wlr nwg-look git slurp timeshift zsh
